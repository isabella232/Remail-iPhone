...
- (NSString*)md5Hash {
    ...
    NSData *hash = IMSHashData_MD5([self bytes]);
    NSString* hash_str = [[[NSString alloc] initWithData:hash
                                                encoding:NSUTF8StringEncoding] autorelease];
    unsigned char *result = (const unsigned char *) [hash_str UTF8String];
#endif
...
#else
    //** iMAS - SecureFoundation
    NSData *hash = IMSHashData_SHA256([self bytes]);
    NSString* hash_str = [[[NSString alloc] initWithData:hash
                                                encoding:NSUTF8StringEncoding] autorelease];
    unsigned char *result = (const unsigned char *) [hash_str UTF8String];
#endif
